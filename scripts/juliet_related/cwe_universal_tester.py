...
Please provide only the replacement code:"""
    ...
    def run_docker_test(self, masked_file, test_file, solution_code):
        ...
        try:
            ...
            cmd = [
                ...
                "--rm",
                "-v",
                f"{masked_file.absolute()}:/tmp/template.java:ro",
                "-v",
                f"{test_file.absolute()}:/tmp/test.java:ro",
    ...
    def test_single_case(self, testcase):
        ...
        # Run Docker test
        stdout, stderr, return_code = self.run_docker_test(
            masked_file, test_file, solution_code
        )
